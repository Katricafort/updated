...
// Example: Assuming your login script saves user info in session
// $_SESSION['user_id'] = 1; // Make sure this exists in your login script
// $_SESSION['firstname'] = "Kat";
// $_SESSION['lastname'] = "Ricafort";
// $_SESSION['email'] = "katrinricafort8@gmail.com";
...
$citizenship = isset($_SESSION['citizenship']) ? $_SESSION['citizenship'] : 'Not set';

// Avatar first letter of first name
$avatarLetter = strtoupper(substr($firstname, 0, 1));

// ✅ Ensure user_id exists before using it
if (isset($_SESSION['user_id'])) {
    ...
    // // ✅ Fetch skills
    // $skills_query = $conn->query("SELECT * FROM skills WHERE user_id = $user_id");

    // // ✅ Fetch education
    // $edu_query = $conn->query("SELECT * FROM education WHERE user_id = $user_id");

    // // ✅ Fetch certificates 
    // $cert_query = $conn->query("SELECT * FROM certificates WHERE user_id = $user_id");
} else {
...
<div class="main-container">
 ...
 <div class="card profile-card">
  ...
  <div class="profile-info">
    ...
    <p><strong>Citizenship:</strong> <?php echo htmlspecialchars($citizenship); ?></p>
  </div>
